...
export const subCompanies: SubCompany[] = [
  ...
  },
  {
    ...
    detail: "Solar, backup power, and renewable energy solutions designed for businesses that need resilient infrastructure.",
    cardClass: "cardSolar",
  ...
  },
  {
    ...
    detail: "Software development, cloud solutions, and AI-enabled systems for organizations ready to modernize their operations.",
    cardClass: "cardTech",
